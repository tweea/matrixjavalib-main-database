...
/**
 * 可以批量执行的 {@link PreparedStatement}。
 */
public class BatchedPreparedStatement
    implements PreparedStatement {
    /**
     * 被包装的 {@link PreparedStatement}。
     */
    ...
    /**
     * 包装一个 {@link PreparedStatement}，不使用批量执行。
     * 
     * @param statement
     *     被包装的 {@link PreparedStatement}
     */
    ...
    /**
     * 包装一个 {@link PreparedStatement}，指定最大批量执行数量。
     * 
     * @param statement
     *     被包装的 {@link PreparedStatement}
     * @param batchSize
     ...
     *     新的执行结果
     */
    private void addBatchResult(final long[] result) {
